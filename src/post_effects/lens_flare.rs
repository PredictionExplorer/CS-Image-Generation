...
impl Default for LensFlareDiffractive {
    fn default() -> Self {
        Self { strength: 0.22, threshold: 0.82 }
    }
}
...
mod tests {
    ...
    fn test_zero_strength_is_passthrough() {
        ...
        let flare = LensFlareDiffractive { strength: 0.0, threshold: 0.5 };
    ...
    fn test_high_threshold_leaves_uniform_dim_image_unchanged() {
        ...
        let flare = LensFlareDiffractive { strength: 0.5, threshold: 0.9 };
