...
pub const CATALOG: &[ModeEntry] = &[
    ...
    entry("V10", "sonification", "The Orbit's Score", "physics", 'B', true),
    entry("V11", "recurrence", "Fingerprint of Chaos", "physics", 'B', true),
    ...
    entry("V16", "chord-progression", "The Harmony of Distances", "physics", 'B', true),
    entry("V17", "epicycles", "The Impossible Machine", "physics", 'B', true),
    ...
    entry("V53", "webgl-viewer", "Hold Your Orbit", "exports", 'B', true),
...
mod tests {
    ...
    fn implemented_waves_are_marked() {
        for flag in [
            ...
            "basin-map",
            "terra",
            // Wave 8 (sound & cinema, plus the orphaned V11)
            "sonification",
            "recurrence",
            "chord-progression",
            "epicycles",
